...
description: "lgtm refactor planning skill. Use when the selected PLAN.md phase is a refactor, cleanup, migration, decomposition, rename, or behavior-preserving change. Builds a minimal safe edit sequence before code changes."
managed-by: lgtm
---
