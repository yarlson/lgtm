...
darwin_amd64="lgtm-v${version}-darwin-amd64.tar.gz"
darwin_arm64="lgtm-v${version}-darwin-arm64.tar.gz"
linux_amd64="lgtm-v${version}-linux-amd64.tar.gz"
linux_arm64="lgtm-v${version}-linux-arm64.tar.gz"
